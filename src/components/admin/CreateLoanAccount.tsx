...
const CreateLoanAccount: React.FC = () => {
  ...
  return (
    <Form
      ...
      scrollToFirstError
    >
      <h1 className='heading'>Create New Loan Account Request</h1>

      {/* Add First Name, Middle Name, and Last Name fields */}
      <Form.Item
        name="accountType"
        label="Loan Account Type"
        rules={[
          {
            required: true,
      ...
      >
        <Select placeholder="Select account type">
          <Option value="savings">Personal Loan</Option>
          <Option value="current">Business Loan</Option>
          <Option value="current">Vehicle Loan</Option>
